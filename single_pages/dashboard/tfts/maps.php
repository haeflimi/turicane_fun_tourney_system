                    ...
                    <form method="post" class="form-inline" name="recordForm<?= $map->getId() ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="user_id" class="form-control" value="<?= $record['user_id'] ?>"/>
                                ...
                                <input type="text" name="record" class="form-control" placeholder="Record"
                                       value="<?= $record['record'] ?>"/>
                                <?php if (!$map->isProcessed()): ?>
                                    <button type="submit" name="update" value="Update" title="Update"
                                            class="btn btn-warning"><i class="fa fa-refresh"></i></button>
                                    <button type="submit" name="delete" title="Delete" value="Delete"
